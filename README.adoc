...
[source,scheme]
----
include::chapter-2/2.3/2.66.scm[]
----
...
1. like Morse code, we can use a special separator code after the sequence for each letter.
2. We can design the code in such a way that no compelete code for any symbol is the prefix of the code for another symbol.
...
[source,scheme]
----
include::chapter-2/2.3/2.67.scm[]
----
...
[source,scheme]
----
include::chapter-2/2.3/2.68.scm[]
----
...
[source,scheme]
----
include::chapter-2/2.3/2.69.scm[]
----
...
[source,scheme]
----
include::chapter-2/2.3/2.70.scm[]
----
...
image::2.71-5.png[align="center"]

Tree for n = 10.

image::2.71-10.png[align="center"]
